...
if [[ $1 =~ ^(-v|-V|--version|--VERSION|version) ]] ; then
    ...
    zenity --info --width=500 --title="SimpleVenom ${setversion} / ${owner}" --text="github: https://github.com/Cyberboysatyam ${dc}\cyber-d{~satyam}: https://github.com/Cyberboysatyam"
    exit 0
fi
## F(x)
